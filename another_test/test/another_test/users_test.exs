defmodule AnotherTest.UsersTest do
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %AnotherTest.Accounts.Account{personal: true} = user.personal_account
      assert [%AnotherTest.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
