defmodule AnotherTestWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use AnotherTestWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint AnotherTestWeb.Endpoint
      ...
      import AnotherTestWeb.ConnCase
    end
  end
  ...
  def register_and_log_in_admin(%{conn: conn}) do
    admin = AnotherTest.AdminsFixtures.admin_fixture()
  ...
  def log_in_admin(conn, admin) do
    conn
    |> Phoenix.ConnTest.init_test_session(%{})
    |> AnotherTest.Admins.Guardian.Plug.sign_in(admin, %{}, key: :admin)
  end
end
